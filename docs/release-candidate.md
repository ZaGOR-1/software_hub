# Software Hub `1.0.0-rc.1` release-candidate evidence
...
Tag `v1.0.0-rc.1` must pass all of the following:
...
```bash
sha256sum --check software-hub-1.0.0-rc.1.tar.gz.sha256
sha256sum --check evidence-manifest.json.sha256
gh attestation verify software-hub-1.0.0-rc.1.tar.gz \
